    ...
    <main className="contact-page">
      ...
      <section className="contact-page-content" aria-labelledby="contact-page-title">
        ...
        <div className="contact-page-links">
          <a href="mailto:thursdaymarksfall505@gmail.com"><span>Email Us</span><small>thursdaymarksfall505@gmail.com</small><b className="ui-arrow" aria-hidden="true" /></a>
          <a href="https://www.instagram.com/thursdaymarksfall" rel="noreferrer" target="_blank"><span>Instagram</span><small>thursdaymarksfall</small><b className="ui-arrow" aria-hidden="true" /></a>
          <a href="https://linktr.ee/thursdaymarksfall" rel="noreferrer" target="_blank"><span>All Links</span><small>All Links</small><b className="ui-arrow" aria-hidden="true" /></a>
        </div>
